...
echo "</Head>";
echo "<Body>";
echo "<form action='findpage.php' method = 'POST'> <button class = 'myButton' name = 'choose' type='submit' value = 'viewRequest'>View Request </button>
<br><br><button class = 'myButton' name = 'choose' type='submit' value = 'acceptedRequest'> Accepted Request </button> <br><br>
<button class = 'myButton' name = 'choose' type='submit' value = 'completedRequest'> Completed Request </button> ";
